...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        input_value.toString(valu_of_var);
        input_value.mak_simp_matr(valu_of_var);
        input_value.toString(input_value.getMat_simp_val());

        System.out.print(input_value.getNum() );
        if (input_value.getNum() == 0) {
            input_value.do_simp_matr_min(input_value.getMat_simp_val());
        } else {
            input_value.do_simp_matr_max(input_value.getMat_simp_val());
        }
    }
}
